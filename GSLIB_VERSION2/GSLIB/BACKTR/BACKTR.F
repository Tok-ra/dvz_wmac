...
c
c-----------------------------------------------------------------------
      parameter(MAXDAT=500000,MAXLEN=132,EPSLON=0.00001,VERSION=2.000)

      real      vr(MAXDAT),vrg(MAXDAT),var(50),ltpar,utpar
      real*8    p
      character datafl*40,outfl*40,transfl*40,str*132
      integer   ltail,utail
